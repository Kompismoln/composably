 ...
 */
export declare const loadContent: (searchPath: string, config: Config, reportVirtualComponent: (component: ComponentContent) => void, reportFileDependency: (filePath: string) => void) => Promise<PageContent>;
/**
