 ...
 */
const validateAndTransformComponent = async (content, config) => {
    ...
    try {
        ...
        console.warn(`Could not load schema for component ${content.component} at ${componentFilePath}: ${error}`);
    ...
    try {
        ...
        if (!result.success) {
            ...
            console.error(`Validation failed for component '${content.component}':`, result.error?.issues || result.error);
        ...
        console.error(`Error during validation/transformation of component '${content.component}':`, error);
